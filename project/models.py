...
if __name__ == "__main__":
    with app.app_context():
        ...
        linh_kien_list = [
            ...
            ("Bugi NGK", 180000, 40000,100, "Bugi"),
            ("Bugi Bosch", 220000, 50000,100, "Bugi"),
            ("Bugi Platinum", 260000, 55000,100, "Bugi"),

            ("Nhớt Castrol", 120000, 20000,100, "Nhớt"),
            ("Nhớt Motul 7100", 180000, 25000,100, "Nhớt"),
            ("Nhớt Total", 150000, 22000,100, "Nhớt"),
            ("Nhớt Shell", 160000, 23000,100, "Nhớt"),
            ("Nhớt Liqui Moly", 200000, 30000,50, "Nhớt"),

            ("Lọc gió K&N", 150000, 30000,50, "Lọc gió"),
            ("Lọc gió Yamaha", 120000, 20000,50, "Lọc gió"),
            ("Lọc gió Honda", 130000, 22000,50, "Lọc gió"),
            ("Lọc gió Air Blade", 110000, 18000,50, "Lọc gió"),
            ("Lọc gió ô tô", 250000, 40000,100, "Lọc gió"),

            ("Ắc quy GS 12V", 850000, 70000,100, "Ắc quy"),
            ("Ắc quy Đồng Nai 12V", 780000, 65000,100, "Ắc quy"),
            ("Ắc quy Vision", 720000, 60000,100, "Ắc quy"),
            ("Ắc quy ô tô Exide", 1500000, 120000,100, "Ắc quy"),
            ("Ắc quy ô tô Amaron", 1700000, 130000,100, "Ắc quy"),

            ("Má phanh trước Yamaha", 320000, 40000,100, "Phanh"),
            ("Má phanh sau Honda", 280000, 35000,100, "Phanh"),
            ("Đĩa phanh ô tô", 1200000, 150000,100, "Phanh"),
            ("Bộ phanh ABS", 2500000, 200000,100, "Phanh"),
            ("Má phanh Suzuki", 300000, 38000,100, "Phanh"),

            ("Dầu thắng Castrol", 90000, 15000, 100,"Dầu thắng"),
            ("Dầu thắng Motul", 100000, 18000, 100,"Dầu thắng"),
            ("Dầu thắng Total", 95000, 16000, 100,"Dầu thắng"),
            ("Dầu thắng DOT4", 85000, 15000, 100,"Dầu thắng"),
            ("Dầu thắng DOT3", 80000, 12000, 100,"Dầu thắng"),

            ("Dầu hộp số Castrol", 200000, 30000, 100,"Dầu hộp số"),
            ("Dầu hộp số Motul", 220000, 35000, 100,"Dầu hộp số"),
            ("Dầu hộp số Shell", 210000, 32000, 100,"Dầu hộp số"),
            ("Dầu hộp số ô tô", 250000, 40000, 100,"Dầu hộp số"),
            ("Dầu hộp số Liqui Moly", 270000, 45000, 100,"Dầu hộp số"),

            ("Lốp Michelin", 1200000, 100000, 100,"Lốp xe"),
            ("Lốp Bridgestone", 1100000, 95000, 100,"Lốp xe"),
            ("Lốp Dunlop", 1000000, 90000, 100,"Lốp xe"),
            ("Lốp xe máy Michelin", 400000, 35000, 100,"Lốp xe"),
            ("Lốp xe máy Pirelli", 380000, 30000, 100,"Lốp xe"),

            ("Dây curoa Vision", 50000, 10000, 100,"Dây curoa / xích"),
            ("Dây curoa Air Blade", 55000, 12000, 100,"Dây curoa / xích"),
            ("Xích xe máy", 80000, 15000, 100,"Dây curoa / xích"),
            ("Dây curoa ô tô", 150000, 25000, 100,"Dây curoa / xích"),
            ("Xích ô tô", 200000, 30000, 100,"Dây curoa / xích"),

            ("Phuộc trước Yamaha", 600000, 50000,100, "Giảm xóc"),
            ("Phuộc sau Honda", 550000, 45000, 50,"Giảm xóc"),
            ("Phuộc trước ô tô", 1500000, 120000, 50,"Giảm xóc"),
            ("Phuộc sau ô tô", 1400000, 110000, 50,"Giảm xóc"),
            ("Giảm xóc Universal", 700000, 60000, 50,"Giảm xóc"),

            ("Đèn pha xe máy", 250000, 30000, 50, "Đèn"),
            ("Đèn hậu xe máy", 150000, 20000, 50, "Đèn"),
            ("Đèn xi-nhan", 100000, 15000, 50, "Đèn"),
            ("Đèn pha ô tô", 1200000, 100000, 50, "Đèn"),
            ("Đèn hậu ô tô", 800000, 70000, 100, "Đèn"),

            ("Lọc nhớt Yamaha", 120000, 15000,60, "Lọc nhớt"),
            ("Lọc nhớt Honda", 110000, 12000, 80,"Lọc nhớt"),
            ("Lọc nhớt ô tô", 250000, 30000, 90,"Lọc nhớt"),
            ("Lọc nhớt Castrol", 130000, 18000, 100,"Lọc nhớt"),
            ("Lọc nhớt Motul", 150000, 20000, 70,"Lọc nhớt"),

            ("Gương chiếu hậu", 180000, 20000, 70,"Phụ tùng khác"),
            ("Còi xe", 90000, 15000, 80,"Phụ tùng khác"),
            ("Tay lái", 250000, 30000, 80,"Phụ tùng khác"),
            ("Chân chống", 80000, 12000, 90,"Phụ tùng khác"),
            ("Bảo vệ sên", 50000, 10000, 90,"Phụ tùng khác"),
            ("Nắp bình xăng", 60000, 12000, 90,"Phụ tùng khác"),
            ("Bộ dây điện", 100000, 20000, 100,"Phụ tùng khác"),
            ("Khóa cổ xe máy", 40000, 8000, 100,"Phụ tùng khác"),
        ]

        hm_dict = {hm.ten_hang_muc: hm.id for hm in hangmuc_objects}

        for ten, gia, tc,sl, hm_name in linh_kien_list:
            lk = LinhKien(
                ten_linh_kien=ten,
                gia=gia,
                tien_cong=tc,
